...
# ADR-037/ADR-042: 4 -> 16 -> 8 -> 4 GiB, tracking real changes to
# pve_power_zfs_arc_max_bytes (ansible/roles/pve_power/defaults/main.yml)
# each time, not just this constant alone -- a drift here silently erodes
# the REL-016 safety margin without CI ever noticing. Keep both in sync.
ZFS_ARC_MAX_GB = 4
