...
| **Paperless OOMKilled (16x in 5h)** | ✅ Fix in PR #39 | Tesseract+Tika OCR-Burst überschritt 1Gi Limit. Fix: Memory-Limit 1Gi→3Gi, CPU 500m→2000m, TASK_WORKERS=2, THREADS=2. |
